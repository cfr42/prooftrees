...
\ProvidesFileSVN{$Id: prooftrees.tex 10516 2024-10-20 18:22:36Z cfrees $}[v0.9 \revinfo]
\GetFileInfoSVN*
...
\tcbuselibrary{listings}%,breakable}% if you use skins, you need to disable externalisation for boxes which use the relevant options - gweler nodiadau/tex/tex.se/tcolorbox-coursepacket-exp.tex
%%%%%%%%%%%%%%%%
...
\begin{description}
  \item[But installation requires slightly more work.] To reap the full benefits, you want to use either the \textt{perl} or the \texttt{python} ‘extraction’ method.
